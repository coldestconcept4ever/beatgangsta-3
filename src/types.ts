...
export interface BeatRecipe {
  ...
  drumKitAdvice?: {
    ...
    kickVirtualInstrumentObj?: { name: string; deepDive: ParameterSetting[] };
    kickFXPlugins?: { name: string; purpose: string; settings?: string; deepDive?: ParameterSetting[] }[];
    snareVirtualInstrument?: string;
    snareVirtualInstrumentObj?: { name: string; deepDive: ParameterSetting[] };
    snareFXPlugins?: { name: string; purpose: string; settings?: string; deepDive?: ParameterSetting[] }[];
    hiHatVirtualInstrument?: string;
    hiHatVirtualInstrumentObj?: { name: string; deepDive: ParameterSetting[] };
    hiHatFXPlugins?: { name: string; purpose: string; settings?: string; deepDive?: ParameterSetting[] }[];
    clapVirtualInstrument?: string;
    clapVirtualInstrumentObj?: { name: string; deepDive: ParameterSetting[] };
    clapFXPlugins?: { name: string; purpose: string; settings?: string; deepDive?: ParameterSetting[] }[];
