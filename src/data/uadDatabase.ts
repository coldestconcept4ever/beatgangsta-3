...
export const UAD_DATABASE: UADPluginProfile[] = [
  ...
  },
  {
    ...
    "parameters": [
      ...
      {
        "name": "Detector Mode",
        "range": "Norm / HP / Band / HP + Band / Link / Link + HP / Link + Band / Link + HP + Band",
        "defaultVal": "Norm",
        "description": "Configures sidechain detector settings. HP cuts low end at 80 Hz, Band boosts midrange around 6 kHz for de-essing, and Link handles stereo sidechain linking.",
        "type": "select",
        "options": [
          "Norm",
          "HP",
      ...
      {
        "name": "Audio Mode",
        "range": "Norm / HP / Dist 2 / Dist 2 + HP / Dist 3 / Dist 3 + HP",
        "defaultVal": "Norm",
        "description": "Injects analog harmonic saturation and main audio path filtering. HP cuts low end at 80 Hz. Dist 2 introduces warm 2nd-order tube-style harmonics, while Dist 3 introduces 3rd-order tape-style saturation.",
        "type": "select",
        "options": [
          "Norm",
          "HP",
      ...
      },
      {
        ...
        "range": "0% to 100%",
        "defaultVal": "100%",
        "description": "Blends unprocessed (dry) signal with the compressed (wet) signal for parallel compression workflows.",
        "type": "knob"
      },
      {
        "name": "Headroom",
        "range": "4 dB to 28 dB",
        "defaultVal": "16 dB",
        "description": "Adjusts the internal operating level reference to control saturation threshold and dynamic response sensitivity.",
        "type": "knob"
      }
    ],
    "proTips": [
  ...
  },
  {
    ...
    "parameters": [
      ...
      },
      {
        ...
        "range": "-20 dB to +20 dB",
        "defaultVal": "0 dB",
        "description": "Controls the input level entering the plugin sidebar pre-amplifier stage.",
        "type": "knob"
      },
      {
        "name": "Gate Threshold",
        ...
        "defaultVal": "-100 dB",
        "description": "Sets the signal level threshold below which the noise gate attenuation activates.",
        "type": "knob"
      },
      {
        "name": "Gate Release",
        ...
        "defaultVal": "100 ms",
        "description": "Controls how quickly the noise gate closes after the signal drops below threshold.",
        "type": "knob"
      },
      {
        "name": "Mic 1 Select",
        "range": "Dyn 57 / Cond 87 / Rib 121",
        "defaultVal": "Dyn 57",
        "description": "Selects the microphone model for the first microphone channel.",
        "type": "switch",
        "options": ["Dyn 57", "Cond 87", "Rib 121"]
      },
      {
        "name": "Mic 1 Volume",
        "range": "-inf dB to 0 dB",
        "defaultVal": "0 dB",
        "description": "Controls the level of the first microphone channel in the cabinet blend.",
        "type": "knob"
      },
      {
        "name": "Mic 1 Pan",
        "range": "L to R",
        "defaultVal": "Center",
        "description": "Controls the stereo pan of the first microphone channel.",
        "type": "knob"
      },
      {
        "name": "Mic 2 Select",
        "range": "Dyn 57 / Cond 87 / Rib 121",
        "defaultVal": "Cond 87",
        "description": "Selects the microphone model for the second microphone channel.",
        "type": "switch",
        "options": ["Dyn 57", "Cond 87", "Rib 121"]
      },
      {
        ...
        "range": "-inf dB to 0 dB",
        "defaultVal": "-inf dB",
        "description": "Controls the level of the second microphone channel in the cabinet blend.",
        "type": "knob"
      },
      {
        "name": "Mic 2 Pan",
        "range": "L to R",
        "defaultVal": "Center",
        "description": "Controls the stereo pan of the second microphone channel.",
        "type": "knob"
      },
      {
        "name": "Master Out",
        "range": "-inf dB to +12 dB",
        "defaultVal": "0 dB",
        "description": "Sets the final output gain level of the plugin sidebar.",
        "type": "knob"
      }
    ],
    "proTips": [
