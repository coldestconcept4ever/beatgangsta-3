...
const updates = [
  {
    targetName: 'JS: Digital Drum Compressor',
    matchName: 'Digital Drum Compressor (DDC) [LOSER]',
    category: 'Dynamics',
    desc: 'Digital Drum Compressor',
    author: 'LOSER',
    sliders: [
      { index: 0, name: 'Threshold', min: -60, max: 0, defaultVal: -20, unit: 'dB' },
      { index: 1, name: 'Ratio', min: 0, max: 50, defaultVal: 20 },
      { index: 2, name: 'Attack', min: 0, max: 500, defaultVal: 20, unit: 'ms' },
      { index: 3, name: 'Hold', min: 0, max: 500, defaultVal: 0.5, unit: 'ms' },
      { index: 4, name: 'Release', min: 0, max: 1000, defaultVal: 200, unit: 'ms' },
      { index: 5, name: 'RMS Size', min: 0, max: 1000, defaultVal: 0, unit: 'ms' },
      { index: 6, name: 'Feed', min: 0, max: 2, defaultVal: 0 },
      { index: 7, name: 'Auto Make-Up', min: 0, max: 1, defaultVal: 1 },
      { index: 8, name: 'Output', min: -120, max: 60, defaultVal: 0, unit: 'dB' },
      { index: 9, name: 'Reduction', min: 0, max: 0, defaultVal: 0 }
    ]
  },
  {
    ...
    sliders: [
      ...
      { index: 5, name: 'Auto Make-Up', min: 0, max: 1, defaultVal: 0 },
